...
export const buildEpisodeUrl = (episode: Episode) =>
  mainUrl + "/episodes/" + getSlug(episode);
export const buildSpeakerUrl = (speaker) =>
  mainUrl + "/speakers/" + speaker.nickName;
export const buildHomepageUrl = () => mainUrl;
export const buildSupportUrl = () => mainUrl + "/support";
